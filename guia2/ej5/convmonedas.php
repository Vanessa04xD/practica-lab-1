...
<body>
    <div class="container mt-5">
        ...
        <div class="mt-4">
            ...
            //tasas convencionales fijas(ejemplo, actualizar segun tasas reales)
            $conversion_rates=[
            ...
            $limit=10;//numero de filas en la tabla
            $counter=1;

            echo "<table class='table table-striped'>";
            echo "<thead><tr><th>#</th><th>Monto (USD)</th><th>Convertido($currency)</th></tr></thead><tbody>";

            while($counter<=$limit)
            {
                $converted=$amount*$rate;
                echo "<tr><td>$counter</td><td>".number_format($amount,2)."</td><td>".number_format($converted, 2) . "</td></tr>";
