    ...
    <div class="containter mt-5">
        <div class="row">
            <div class="col-12">
                ...
                <p class="lead text-center">A continuacion se muestran los valores de las variables definicdas en PHP</p>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Valor de la variable $a (entero) : </h
                        <p class="card-text">
                            <?php
                            $a=10;
                            echo $a;
